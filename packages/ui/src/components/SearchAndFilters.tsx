      ...
      <CardContent>
        ...
        {filters.some(
          filter =>
            ...
            getMultiSelectedValues(filter.value).length > 0
        ) && (
          <div className="mb-4">
            <div className="flex flex-wrap gap-2">
              {filters.map(filter => {
                if (!isMultiFilter(filter)) return null;
                ...
                return selectedValues.map(selectedValue => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        onClick={() =>
                          removeSelectedValue(filter, selectedValue)
                        }
                    ...
                    <>
                      {filter.options.map(option => {
                        ...
                        return (
                          <div
                            key={option.value}
                            className="hover:bg-accent flex items-center space-x-2 px-2 py-1.5"
                          >
                            <Checkbox
                              checked={isSelected}
