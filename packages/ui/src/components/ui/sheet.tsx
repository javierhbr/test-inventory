...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <BaseDialog.Close className="rounded-xs focus:outline-hidden ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute right-4 top-4 opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none">
